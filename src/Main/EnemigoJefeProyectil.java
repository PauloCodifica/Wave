...
public class EnemigoJefeProyectil extends ObjetoJuego
{
    ...
    public EnemigoJefeProyectil( int x, int y, ID id, Manejador manejador )
    {
        super( x, y, id );
    ...
    public void tick()
    {
        ...
        manejador.agregarObjeto( new Trazo( x, y, ID.Trazo, Color.RED, 16, 16, 0.02f, manejador ) );
    }
